...
const UvodObuke = () => {
  return (
    <div className='mt-10 lg:w-[1140px] m-auto'>
        ...
        <p className='mb-12 text-gray-500'>Obuka cvet života je duhovna škola koja se prolazi kroz tri nadovezujuće celine.</p>
        </div>
        <div className='w-[365px] m-auto px-2 md:w-full md:flex'>
            ...
            <div className='p-4 border-slate-200 border-[1px] mb-5 lg:w-[365px]'>
                ...
                <p className='text-gray-500'>To je neka vrsta napredne duhovne individualne obuke i upućivanja u najdublja znanja o načinu funkcionisanja sveta i njegovoj promeni. Ovaj deo obuke se zavredjuje tek nakon dužeg rada i rezervisan je za one najposvećenije.</p>
