...
const Item = ({ itemData }) => {
    ...
    return (
        <div className='p-5'>
            <p className='font-velikaslova text-2xl pb-10 md:text-3xl mt-5 '>{itemData.title}</p>
            <div className="grid">
                <p className='leading-7 mr-0 lg:mr-20 md:h-[550px]'>
                    {
                        itemData.content.map((content) => (<span>{content}<br></br></span>))
                    }
                </p>
