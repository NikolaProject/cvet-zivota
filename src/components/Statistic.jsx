...
const Statistic = () => {
  return (
    <div className=' bg-statistika bg-cover h-[1000px] bg-center text-center'> 
        ...
        <div className='pr-3'>
            <p className='font-velikaslova text-2xl md:text-5xl text-white'>150+</p>
            <p className='text-siva'>Duhovnih oblasti</p>
          </div>
          
          <div className='pr-2'>
           <p className='font-velikaslova text-2xl md:text-5xl text-white'>300+</p>
           <p className='text-siva text-sm'>zajedničkih sprovedenih akcija za<br/> globalno dobro</p>
         </div>
         <div className='pr-2'>
            <p className='font-velikaslova text-2xl md:text-5xl text-white'>500+</p>
            <p className='text-siva text-sm'>Aktivnih članova</p>
          </div>
          <div>
           <p className='font-velikaslova text-2xl md:text-5xl text-white'>800+</p>
            <p className='text-siva text-sm'>Održanih kurseva</p>
          </div>
          </div>
        </div>
