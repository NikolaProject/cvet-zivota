  ...
  return (
    <div className=' lg:w-[1140px] font-opensans m-auto mt-12 justify-between items-center flex mb-24'>
      ...
      <img src={Slikakrug} className='hidden lg:flex' alt="" />
        ...
        <br></br><br></br>
        Svaki kurs je odvojena celina i sa svakim sledećim nivoom zanje i sposobnosti se produbljuju. Niko nije u obavezi da pohadja sve kurseve, već ko je zadovoljan sa onime sto je naucio i zeli nauciti jos, moze krenuti na sledeci kurs kada on to želi(mesečno jednom ima svaki nivo kursa online). 
        <br></br><br></br>
        
        Svaki kurs je ujedno i rad na nasem očišćenju i duhovnom uzdizanju,stoga je svaki krus vrsta tretmana,ali gde sam učenik sebe čisti uz vodjstvo instrukora.</p>
        <div className=''>
        <img src="" alt="" />
        <img src="" alt="" />
